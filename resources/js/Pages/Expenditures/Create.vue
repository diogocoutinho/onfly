                    ...
                    <form @submit.prevent="submit">
                        ...
                        <div class="row">
                            <div class="col-4 mt-4">
                                ...
                                <BreezeInput id="datetime-local" type="datetime-local" class="mt-1 block w-full" v-model="form.datetime" required autocomplete="datetime" />
                            </div>
                            <div class="col-4 mt-4">
...
export default {
  ...
  methods: {
    submit() {
        this.form.post(this.route('expenditures.store', this.form), {
