                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form @submit.prevent="submit">
                        <div>
                            ...
                            <textarea id="description" class="mt-1 block w-full" maxlength="191" disabled v-model="form.description" required autofocus autocomplete="description" ></textarea>
                        </div>

                        <div class="row">
                            <div class="col-4 mt-4">
                                <BreezeLabel for="datetime-local" value="Data" />
                                <BreezeInput id="datetime-local" disabled type="datetime-local" class="mt-1 block w-full" v-model="form.date" required autocomplete="datetime" />
                            </div>
                            <div class="col-4 mt-4">
                                <BreezeLabel for="user" value="Usuário" />
                                <select class="mt-1 block w-full" id="user" disabled v-model="form.user_id">
