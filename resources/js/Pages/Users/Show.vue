                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form @submit.prevent="submit">
                        <div>
                            ...
                            <BreezeInput id="name" type="text" class="mt-1 block w-full" v-model="form.name" disabled required autofocus autocomplete="name" />
                        </div>

                        <div class="mt-4">
                            <BreezeLabel for="email" value="Email" />
                            <BreezeInput id="email" type="email" class="mt-1 block w-full" v-model="form.email" disabled required autocomplete="username" />
                        </div>
                    </form>
                </div>
            </div>
