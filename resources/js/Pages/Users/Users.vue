                                    ...
                                    <div class="hidden sm:flex sm:items-center sm:ml-6">
                                        <div class="ml-3 relative">
                                            <BreezeDropdown align="left" width="48">
                                                ...
                                                <template #content>
                                                    <BreezeDropdownLink :href="route('users.show', user)" method="get" as="button">
                                                        Ver
                                                    </BreezeDropdownLink>
                                                    <BreezeDropdownLink :href="user.edit_url" method="get" as="button">
                                                        Editar
                                                    </BreezeDropdownLink>
                                                    <BreezeDropdownLink @click="deleteUser(user.id)" method="delete" as="button">
                                                        Apagar
                                                    </BreezeDropdownLink>
                                                </template>
                                            </BreezeDropdown>
